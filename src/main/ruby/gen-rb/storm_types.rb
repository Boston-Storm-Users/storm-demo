...
class BoltStats
  ...
  FIELDS = {
    ...
    EXECUTED => {:type => ::Thrift::Types::MAP, :name => 'executed', :key => {:type => ::Thrift::Types::STRING}, :value => {:type => ::Thrift::Types::MAP, :key => {:type => ::Thrift::Types::STRUCT, :class => GlobalStreamId}, :value => {:type => ::Thrift::Types::I64}}},
    EXECUTE_MS_AVG => {:type => ::Thrift::Types::MAP, :name => 'execute_ms_avg', :key => {:type => ::Thrift::Types::STRING}, :value => {:type => ::Thrift::Types::MAP, :key => {:type => ::Thrift::Types::STRUCT, :class => GlobalStreamId}, :value => {:type => ::Thrift::Types::DOUBLE}}}
  }
...
class SubmitOptions
  ...
  FIELDS = {
    INITIAL_STATUS => {:type => ::Thrift::Types::I32, :name => 'initial_status', :enum_class => TopologyInitialStatus}
  }
  ...
  def validate
    ...
    unless @initial_status.nil? || TopologyInitialStatus::VALID_VALUES.include?(@initial_status)
